...
export default class ServiceAccountModal extends Vue {
  ...
  @Prop(String) readonly pServiceName!: string;
  @Prop(String) readonly pMailId!: string;
  @Prop(String) readonly pPassword!: string;
  @Prop(String) readonly pMemo!: string;

  private id: number = this.pId;
  private serviceName: string = this.pServiceName;
  private mail_id: string = this.pMailId;
  private password: string = this.pPassword;
  private memo: string = this.pMemo;
